...
<template>
    ...
    <main class="tw-mx-auto tw-w-full tw-max-w-7xl">
        ...
        <div class="tw-flex sm:tw-flex-row tw-flex-col tw-justify-between tw-items-center tw-gap-3 tw-mb-5 tw-w-full">
            <SearchFilter v-model="form.search" class="tw-rounded-lg tw-w-full sm:tw-w-auto" @reset="resetSearch">
            </SearchFilter>
            <div class="tw-flex tw-justify-between tw-gap-x-2 tw-w-full">
                <Link as="button" class="sm:tw-ml-auto tw-btn-create tw-group" :href="route('admin.sales.create')">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                    ...
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" d="M5 12h14m-7-7v14"></path>
                </svg>
                New Sale
                </Link>
                <div class="flex-1 tw-w-fit tw-max-w-fit">
                    <div class="tw-flex !tw-flex-row tw-items-center tw-rounded-md">
                        <Link tabindex="0"
                            ...
                            :href="route('admin.sale-returns.index')" as="button">
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            class="tw-mr-1 tw-size-5 additional-class" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                                <path d="M168 96v112a8 8 0 0 1-8 8H48a8 8 0 0 1-8-8V96a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8"
                                    opacity=".2"></path>
                                <path
                        ...
                        <Link :href="route('admin.sale-returns.create')" tabindex="0"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" class="tw-size-5" width="1em" height="1em" viewBox="0 0 24 24">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="M5 12h14m-7-7v14"></path>
                        </svg>
                        </Link>
            ...
            <template v-for="sale in props.sales.data" :key="sale.id">
                ...
                <div
                    ...
                    <div
                        ...
                        <img class="tw-size-12" src="/public/assets/invoice.png" alt="">
                        <div class="tw-text-slate-500">
                            <h4 class="tw-font-semibold"> <span class="sm:tw-hidden"> BILL NO: </span>{{
                                sale.bill_no }}</h4>
                            <p class="tw-font-medium"><span class="sm:tw-hidden">Date: </span>{{ sale.sale_date
                                }}</p>
                        </div>
                        <div class="sm:tw-hidden tw-ml-auto pr-2">
                            <Link :href="route('admin.sales.show', sale.id)" as="button" type="button"
                    ...
                    <!-- Bottom row phone-->
                    <div class="tw-flex tw-flex-col tw-gap-2 sm:tw-hidden tw-mt-1">
                        <div class="tw-flex tw-justify-between tw-items-center tw-px-2 tw-h-8 tw-w-full">
                    ...
                    <!-- Bottom row tablet+ -->
                    <div
                        class="sm:tw-flex tw-flex-col tw-justify-center tw-items-start tw-gap-y-1 tw-hidden tw-col-span-3 pl-1 tw-text-sm">
                        <p>{{ sale.customer.name }}</p>
                        <p>{{ sale.customer.address }}</p>
                    </div>
                    <div class="sm:tw-flex tw-flex-col tw-justify-center tw-items-end tw-hidden tw-col-span-3 tw-p-2">
                        <p class="tw-font-semibold tw-text-base tw-text-gray-600 tw-leading-none">Total: {{
                            sale.grand_total }} BDT</p>
                        <p class="tw-ml-1 tw-text-gray-400 tw-text-sm tw-leading-snug">Paid: {{
                            sale.paid_amount }} BDT
                        </p>
                    </div>
                    <div class="sm:tw-flex tw-justify-end tw-items-center tw-gap-2 tw-hidden tw-col-span-3 tw-p-2">
                        <Link :href="route('admin.sales.show', sale.id)" as="button" type="button"
                            class="tw-rounded-md tw-btn tw-btn-secondary tw-h-10 tw-w-full sm:tw-w-32 tw-min-h-10">
                        Preview
                        </Link>
                        <Menu class="tw-relative" as="div">
                            <MenuButton>
                                <Icon class="tw-fill-slate-500" icon="vertical-dots" />
                            </MenuButton>
                            ...
                            <MenuItems
                                ...
                                <Link
                                    ...
                                    :class="{ 'tw-bg-orange-600 tw-text-white': active }"
                                    :href="route('admin.sales.edit', sale.id)" as="button">
                                Edit
                                </Link>
                                </MenuItem>
                                <MenuItem v-slot="{ active }">
                                <button
                                    ...
                                    :class="{ 'tw-bg-orange-600 tw-text-white': active }" @click="destroyItem(sale.id)">
                                    Delete
                                </button>
                                </MenuItem>
                            </MenuItems>
